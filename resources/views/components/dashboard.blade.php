    ...
    <div class="min-h-screen flex">
        ...
        <aside id="sidebar" class="fixed overflow-y-scroll no-scrollbar top-0 left-0 h-screen w-64 bg-white shadow-lg transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out z-40">
            ...
            <div class="flex items-center justify-center h-16 border-b">
                <span class="text-indigo-600 font-bold text-2xl">{{ config('app.name', 'Laravel') }} Admin</span>
                <!-- Mobile Close Button -->
            ...
            <nav class="py-4">
                ...
                <div class="px-4 space-y-1">
                    <!-- Dashboard -->
                    <a href="" class="text-indigo-600 bg-indigo-50 flex items-center gap-3 px-4 py-2 rounded-lg">
                    ...
                    <div class="space-y-1 pt-2">
                        ...
                        <a href="" class="text-gray-600 hover:bg-gray-100 flex items-center gap-3 px-4 py-2 rounded-lg">
