        ...
        <div class="container mx-auto px-4 md:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-6 relative z-20">
                <form class="flex flex-col md:flex-row gap-4 items-center">
                    <div class="flex-grow">
                        <input type="text" autocomplete="off" id="search" placeholder="Search by location, property name, or amenities" class="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF5A5F] focus:border-[#FF5A5F]">
                    </div>
                    <div class="md:w-48">
                        <select id="perPage" class="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF5A5F] focus:border-[#FF5A5F]">
                ...
                <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300 border border-gray-200">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button class="bg-[#FF5A5F] hover:bg-[#E94E53] text-white px-4 py-2 rounded-lg font-medium transition duration-300 ease-in-out">View Details</button>
                        </div>
                    </div>
                </div>
